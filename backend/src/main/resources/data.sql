...
insert into  tb_movie (id_genre, title, sub_title, year, img_url, synoposis)  values (2, 'Código de Conduta', 'Law Abiding Citizen', 2009, 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/ganM82DDp4QQz2qa7Xjt0sq0uz5.jpg' , 'Quando um dos suspeitos do assassinato de sua mulher e filha é solto, Clyde quer vingança e decide fazer justiça com as próprias mãos. Clyde é preso e dentro da cadeia organiza uma matança para desmascarar o sistema judicial corrupto.');
